...
from src.components.model_trainer import ModelTrainerConfig #filepath
...
if __name__=="__main__":
    ...
    print(modeltrainer.initiate_model_trainer(train_arr,test_arr)) #initiate_model_trainer is the function name